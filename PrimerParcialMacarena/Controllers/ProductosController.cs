...
namespace PrimerParcialMacarena.Controllers
{
    public class ProductosController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            ViewBag.CantidadTotal = productos.Count; 
            ViewBag.CantidadFavoritos = productos.Count(p => p.Favorito); 
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Precio,Marca,Favorito,CategoriaId")] Producto producto)
        {
            if (id != producto.Id)
            {
                return NotFound();
